...
same handful of strings is submitted for the life of the process, reached within
the first few calls, and nothing here ever interpolates a value into SQL. That is exactly the shape a server-side prepared
