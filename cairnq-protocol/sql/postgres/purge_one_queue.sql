-- purge_one_queue, for a sweep bounded to one queue. Byte-for-byte purge.sql
-- except that the queue filter is an equality instead of an optional `is null
...
-- is what lets this seek cairnq_tasks_queue_completed_idx (migration 0009) and
